...
\DefunWithValues hash-table-p {object} {boolean}
...
\DefunWithValues remhash {key hash-table} {boolean}
...
\itemitem{1.} A \term{boolean} that is \term{true} if an entry is returned.
