...
\DefunWithValues characterp {object} {boolean}
...
\DefunWithValues alpha-char-p {character} {boolean}
...
\DefunWithValues alphanumericp {character} {boolean}
...
\DefunWithValues graphic-char-p {char} {boolean}
...
\DefunWithValues standard-char-p {character} {boolean}
...
\DefunMultiWithValues {character} {boolean}
  {\entry{upper-case-p}
   \entry{lower-case-p}
   \entry{both-case-p}}
