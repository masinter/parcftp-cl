...
\issue{PACKAGE-FUNCTION-CONSISTENCY:MORE-PERMISSIVE}
\param{name}---a \term{package designator}.
\endissue{PACKAGE-FUNCTION-CONSISTENCY:MORE-PERMISSIVE}
...
\endissue{PACKAGE-FUNCTION-CONSISTENCY:MORE-PERMISSIVE}
If there is no such \term{package}, \funref{find-package} returns \nil.
 
%% 11.0.0 21
The \funref{find-package} search is case sensitive.
...
\param{new-nicknames}---a \term{list} of \term{package name designators}.
...
\param{symbol-names}---a \term{designator} for 
		       a \term{list} of \term{symbol name designators}.
...
\DefunWithValues delete-package {package} {boolean}
...
\param{package-name}---a \term{package name designator}.

\param{nicknames}---a \term{list} of \term{package name designators}.
  \Default{the \term{empty list}}
...
\DefunWithValues unintern {symbol {\opt} package} {boolean}
...
\param{name}---a \term{package name designator}; \noeval.
...
\param{defined-package-name}---a \term{package name designator}.
...
\param{nickname}---a \term{package name designator}.

\param{symbol-name}---a \term{symbol name designator}.
...
supplied names.
%% Sandra: Implied by symbol name designator.
...
\DefunWithValues packagep {object} {boolean}
