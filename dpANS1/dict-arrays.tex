...
\param{adjustable}---a \term{boolean}.
 \Default{\nil}
...
it is used to initialize each element of \term{array}. 
If \param{initial-element} is supplied,
...
or \param{displaced-to} is \term{non-nil}.
If \param{initial-contents} is not supplied, the initial values of the
\term{array} \term{elements} are 
%%Rewritten to conform to the fact that issue UNINITIALIZED-ELEMENTS failed
%%to clarify this in the other direction because consensus was that this was well-defined
%%already. -kmp 15-Jan-92
%undefined
...
\DefunWithValues adjustable-array-p {array} {boolean}
...
\DefunWithValues array-has-fill-pointer-p {array} {boolean}
...
\DefunWithValues array-in-bounds-p {array {\rest} subscripts} {boolean}
...
\DefunWithValues arrayp {object} {boolean}
...
\DefunWithValues simple-vector-p {object} {boolean}
...
\DefunWithValues vectorp {object} {boolean}
...
\DefunWithValues bit-vector-p {object} {boolean}
...
\DefunWithValues simple-bit-vector-p {object} {boolean}
