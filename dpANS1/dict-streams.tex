...
it is defined that
the \term{values} returned by such an output operation are 
...
\DefunWithValues input-stream-p {stream} {boolean}
\DefunWithValues output-stream-p {stream} {boolean}
...
\DefunWithValues interactive-stream-p {stream} {boolean}
...
\DefunWithValues open-stream-p {stream} {boolean}
...
\DefunWithValues {streamp} {object} {boolean}
...
\param{eof-error-p}---a \term{boolean}.
 \Default{\term{true}}
...
\param{recursive-p}---a \term{boolean}.
 \Default{\term{false}}
...
\DefunWithValues {fresh-line} {{\opt} output-stream} {boolean}
...
\param{missing-newline-p}---a \term{boolean}.
...
\DefunWithValues {listen} {{\opt} input-stream} {boolean}
...
\DefunWithValues {y-or-n-p}    {{\opt} control {\rest} arguments} {boolean}
\DefunWithValues {yes-or-no-p} {{\opt} control {\rest} arguments} {boolean}
