...
and&long-float&simple-array\cr
array&member&simple-base-string\cr
base-string&mod&simple-bit-vector\cr
bit-vector&not&simple-string\cr
complex&or&simple-vector\cr
double-float&rational&single-float\cr
eql&real&string\cr
float&satisfies&unsigned-byte\cr
function&short-float&values\cr
integer&signed-byte&vector\cr
}
