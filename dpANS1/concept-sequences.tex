...
\term{Sequences} can be created by \thefunction{make-sequence}, as well
as other \term{functions} that create \term{objects} of \term{types} that are
\term{subtypes} of \typeref{sequence} (\eg \funref{list}, \funref{make-list}, 
\funref{mapcar}, and \funref{vector}).
