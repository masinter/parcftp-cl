...
defun&labels&define-method-combination\cr
flet&lambda&\cr
}
...
\term{keyword parameters}, then an error \oftype{error} should be signaled if
...
\auxbnf{lambda-list}{\lparen\star{\SpecializedVar}\CR
		     \ \ttbrac{{\opt} \star{\VarValueSuppliedP}}\CR
		     \ \ttbrac{{\rest} \param{var}}\CR
		     \ \ttbrac{{\key} \star{\VarValueSuppliedP} \brac{\allowotherkeys}}\CR
		     \ \ttbrac{{\aux} \star{\VarValue}}\rparen\CR}
...
A \term{macro lambda list} can contain the \term{lambda list keywords} shown
in \thenextfigure.
...
%% 8.1.0 10
\keyref{body} is identical in function to \keyref{rest},
...
%% 8.1.0 11
\keyref{whole} is followed by a single variable that is bound to the
...
\beginsubsubsection{Destructuring of Lambda Lists}
\DefineSection{DestructuringOfLambdaLists}
...
\beginsubsubsubsection{Data-directed Destructuring of Lambda Lists}
...
\beginsubsubsubsubsection{Examples of Data-directed Destructuring of Lambda Lists}
...
\endsubsubsubsubsection%{Examples of Data-directed Destructuring of Lambda Lists}

\endsubsubsubsection%{Data-directed Destructuring of Lambda Lists}

\beginsubsubsubsection{Lambda-list-directed Destructuring of Lambda Lists}
...
\endsubsubsubsection%{Lambda-list-directed Destructuring of Lambda Lists}

% \beginsubsubsubsection{Additional Information about Destructuring of Lambda Lists}
...
% \endsubsubsubsection%{Additional Information about Destructuring of Lambda Lists}

\endsubsubsection%{Destructuring of Lambda Lists}
