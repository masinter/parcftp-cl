...
\param{non-terminating-p}---a \term{boolean}.
 \Default{\term{false}}
...
\param{preserve-whitespace}---a \term{boolean}.
 \Default{\term{false}}
...
\DefunWithValues readtablep {object} {boolean}
...
Each of the \f{\#A}, \f{\#S}, and \f{\#:} notations reads the following
\term{object} in suppressed mode but does not interpret it in any way;
it need not even be a \term{list} in the case of \f{\#S}, or a 
