...
The \term{type} \f{string-char} was removed.
...
\issue{CHARACTER-PROPOSAL:2-1-1}
The \param{font} argument to \funref{digit-char} was removed.
The \param{bits} and \param{font} arguments to \funref{code-char} were removed.
\endissue{CHARACTER-PROPOSAL:2-1-1}

\issue{REQUIRE-PATHNAME-DEFAULTS-AGAIN:X3J13-DEC-91}
The \param{pathname} argument to \funref{require} was removed.
\endissue{REQUIRE-PATHNAME-DEFAULTS-AGAIN:X3J13-DEC-91}
...
The \term{packages} \packref{lisp}, \packref{user}, and \packref{system} are
no longer required.  It is valid for \term{packages} with one or more of these
