...
\DefunWithValues simple-string-p {object} {boolean}
...
\DefunWithValues {string$=$} {string1 string2 {\key} start1 end1 start2 end2} {boolean}

\DefunMultiWithValues {string1 string2 {\key} start1 end1 start2 end2} {mismatch-index}
  {\entry{string/$=$}
   \entry{string$<$}
   \entry{string$>$}
   \entry{string$<=$}
...
\DefunWithValues {string-equal} {string1 string2 {\key} start1 end1 start2 end2} {boolean}
...
% -kmp 13-Jan-92
The equality functions return a \param{boolean} 
...
\DefunWithValues stringp {object} {boolean}
