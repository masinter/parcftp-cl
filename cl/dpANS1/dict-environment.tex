...
\param{string}---a \term{symbol name designator}.
...
\DefgenWithValues documentation {x {\opt} doc-type} {documentation}

\DefgenWithValues {(setf documentation)} {new-value x {\opt} doc-type} {new-value}
...
\Defmeth {documentation} {\specparam{x}{function}           {\opt} \param{doc-type}}
\Defmeth {documentation} {\specparam{x}{list}               {\opt} \param{doc-type}}
\Defmeth {documentation} {\specparam{x}{method-combination} {\opt} \param{doc-type}}
\Defmeth {documentation} {\specparam{x}{package}            {\opt} \param{doc-type}}
\Defmeth {documentation} {\specparam{x}{standard-class}     {\opt} \param{doc-type}}
\Defmeth {documentation} {\specparam{x}{standard-method}    {\opt} \param{doc-type}}
\Defmeth {documentation} {\specparam{x}{structure-class}    {\opt} \param{doc-type}}
\Defmeth {documentation} {\specparam{x}{symbol}             {\opt} \param{doc-type}}
\Defmeth {(setf documentation)} {\param{new-value} \specparam{x}{function}           {\opt} \param{doc-type}}
\Defmeth {(setf documentation)} {\param{new-value} \specparam{x}{list}               {\opt} \param{doc-type}}
\Defmeth {(setf documentation)} {\param{new-value} \specparam{x}{method-combination} {\opt} \param{doc-type}}
\Defmeth {(setf documentation)} {\param{new-value} \specparam{x}{package}            {\opt} \param{doc-type}}
\Defmeth {(setf documentation)} {\param{new-value} \specparam{x}{standard-class}     {\opt} \param{doc-type}}
\Defmeth {(setf documentation)} {\param{new-value} \specparam{x}{standard-method}    {\opt} \param{doc-type}}
\Defmeth {(setf documentation)} {\param{new-value} \specparam{x}{structure-class}    {\opt} \param{doc-type}}
\Defmeth {(setf documentation)} {\param{new-value} \specparam{x}{symbol}             {\opt} \param{doc-type}}
\endissue{DOCUMENTATION-FUNCTION-BUGS:FIX}%
\logidx{compiler-macro}%
\logidx{function}%
\logidx{method-combination}%
\logidx{setf}%
\logidx{structure}%
\logidx{type}%
\logidx{variable}%
...
\param{doc-type}---If \param{x} is a \term{symbol} or a \term{list},
...
%!!! wording??
Returns the \term{documentation string} of 
the \term{structure name} 
which is the \term{symbol} \param{x}.
...
Otherwise, it returns the \term{documentation string} of
the \term{type} 
...
The remaining \term{methods} are specialized on the \term{class} of
the argument \param{x}, as follows:
...
%% Done, sort of.  I hope it's satisfactory.
% %!!! Merge with previous. (Several people, most recently Sandra, have requested it.)
% %%% ========== (SETF DOCUMENTATION)
% \begincom{(setf documentation)}\ftype{Standard Generic Function}
%  
% \label Syntax::
%  
% \DefgenWithValues {(setf documentation)} {new-value x {\opt} doc-type} {new-value}
...
% \label Method Signatures::
%  
% \Defmeth {(setf documentation)} {\vtop{\hbox{\param{new-value} (\param{x} standard-method)}
% 				       \hbox{{\opt} \param{doc-type}}}}
% 
% \issue{DOCUMENTATION-FUNCTION-BUGS:FIX}
% \Defmeth {(setf documentation)} {\vtop{\hbox{\param{new-value}}
% 				       \hbox{(\param{x} function)}
% 				       \hbox{{\opt} \param{doc-type}}}}
% \endissue{DOCUMENTATION-FUNCTION-BUGS:FIX}
%  
% \Defmeth {(setf documentation)} {\vtop{\hbox{\param{new-value} (\param{x} standard-class)}
% 				       \hbox{{\opt} \param{doc-type}}}}
%  
% \issue{DOCUMENTATION-FUNCTION-BUGS:FIX}
% \Defmeth {(setf documentation)} {\vtop{\hbox{\param{new-value} (\param{x} structure-class)}
% 				       \hbox{{\opt} \param{doc-type}}}}
% 
% \Defmeth {(setf documentation)} {\vtop{\hbox{\param{new-value} (\param{x} package)}
% 				       \hbox{{\opt} \param{doc-type}}}}
% \endissue{DOCUMENTATION-FUNCTION-BUGS:FIX}
% 
% \Defmeth {(setf documentation)} {\vtop{\hbox{\param{new-value}}
% 				       \hbox{(\param{x} method-combination)}
% 				       \hbox{{\opt} \param{doc-type}}}}
%  
% \issue{DOCUMENTATION-FUNCTION-BUGS:FIX}
% % \Defmeth {(setf documentation)} {\vtop{\hbox{\param{new-value}}
% % 				       \hbox{(\param{x} standard-slot-description)}
% % 				       \hbox{{\opt} \param{doc-type}}}}
% \endissue{DOCUMENTATION-FUNCTION-BUGS:FIX}
%  
% \Defmeth {(setf documentation)} {\vtop{\hbox{\param{new-value} (\param{x} symbol)}
% 				       \hbox{{\opt} \param{doc-type}}}}
%                                  
% \Defmeth {(setf documentation)} {\vtop{\hbox{\param{new-value} (\param{x} list)}
% 				       \hbox{{\opt} \param{doc-type}}}}
%  
% \label Arguments and Values::
%  
...
%  
% \param{x}---an \term{object}.
% %% Constrained by the above. -kmp 3-Sep-91
% %             a \term{symbol}, 
% % 	    a \term{list}, 
% % 	    a \term{method},
% % 	    a \term{class}, 
...
% \label Description::
%  
% %!!! Make this be more like the entry for DOCUMENTATION.
% 
% The \term{generic function} \f{(setf documentation)} updates the 
% \term{documentation string} associated with \param{x} to \param{new-value}.
% If \param{x} is a \term{list}, it must be of the form                                   
% \f{(setf \param{symbol})}.
%  
% The forms
%  {\tt (setf (documentation \param{symbol} 'function) \param{new-value})}
% and
%  {\tt (setf (documentation '(setf \param{symbol}) 'function) \param{new-value})}
% update the \term{documentation string} of the \term{function}, 
% \term{special form}, or \term{macro} named by the \param{symbol} or \term{list}.
%  
% The form
%  {\tt (setf (documentation \param{symbol} 'variable) \param{new-value})} 
% updates the \term{documentation string} of the special variable or \term{constant}
% named by the \param{symbol}.
%  
% The form
%  {\tt (setf (documentation \param{symbol} 'structure) \param{new-value})}
% updates the \term{documentation string} of the \macref{defstruct} structure named
% by the \param{symbol}.
%  
% The form
%  {\tt (setf (documentation \param{symbol} 'type) \param{new-value})}
% updates the \term{documentation string} of the \term{class} \term{object}
% named by the \param{symbol}, if there is such a \term{class}.
% If there is no such \term{class}, it updates the \term{documentation string} of 
% the \term{type specifier} named by the \param{symbol}.
%  
% The form
%  {\tt (setf (documentation \param{symbol} 'setf) \param{new-value})}
% updates the \term{documentation string} of the \macref{defsetf} or
% \issue{SETF-METHOD-VS-SETF-METHOD:RENAME-OLD-TERMS}
% \macref{define-setf-expander}
% \endissue{SETF-METHOD-VS-SETF-METHOD:RENAME-OLD-TERMS}
% definition associated with the \param{symbol}.
%  
% The form
%  {\tt (setf (documentation \param{symbol} 'method-combination) \param{new-value})}
% updates the \term{documentation string} of the method combination type named 
% by the \param{symbol}.
%  
% An implementation may extend the set of \term{symbols} that are acceptable as
% the \param{doc-type} argument.  If \param{doc-type} is not recognized as an
% acceptable argument by the implementation, an error must be signaled.
% 
% %The \term{documentation string} of \param{x} is set.
%  
% \label Examples:\None.
%  
% \label Affected By:\None.
...
%  or a \term{method combination} \term{object},
% \issue{DOCUMENTATION-FUNCTION-BUGS:FIX}
% % or a \term{slot} description \term{object},
% \endissue{DOCUMENTATION-FUNCTION-BUGS:FIX}
% and the \param{doc-type} argument is supplied,
% an error is signaled.
%  
% An implementation may extend the set of \term{symbols} 
% that are acceptable as the \param{doc-type} argument.
% If a \term{symbol} is not recognized 
% as an acceptable argument by the implementation,
